...
<head>
<meta charset="utf-8">
<title>Meditation Balls Selection</title>
...
<br>
<center class="Store-Items-Title">
	<h1>Assorted Colours Based On Availability</h1>
</center>
<br>
...
<section class="cards">
    <?php
        ...
        $sql = "SELECT id, images, name, price FROM meditations_balls_info";
...
<article class="card">
	<form method="post" action="Meditation Balls.php"?action=add&id" <?php echo $row["id"]; ?>>
		<div>
		<br>
